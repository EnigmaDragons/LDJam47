...
public class ChoiceHolder : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        { 
           ...
           "PLAYER_NAME: There are literally zero cops in this part of town. You’ll be fine. = next #25",
           ...
           "PLAYER_NAME: I had this gig managing a motocross park during the week but my ex got pissed and told the manager about the parties I was throwing there so now on Monday I gotta go in and apologize and junk. How about you? = next #29",
           "PLAYER_NAME: My ex used to make these jewelry things and I was helping her sell them online before we broke up. But I still have access to her paypal, which is nice. How about you? = next #29",
           "Robin: Oh, I’m an agent at Compass Realty Group. = [Horse Betting] #30 = [Can you sell my RV] #31 = [I could be a realtor] #32",
           "PLAYER_NAME: Oh dang. Yeah y'all have a big billboard on route 183 right outside the horse racing track. Two weekends ago I went to the track with some friends and my buddy Eric and I bet $250 on the race. I’ve never seen someone lose their paycheck that fast. = next #33",
           "PLAYER_NAME: Oh so you sell houses and junk? I have this old RV my Grandad left me that I was thinking about selling. But I put a lot of work into it so maybe not. When I turn on all the interior lights it looks like one of those professional party buses and I have some pretty nice speakers too. = next #33",
           ...
           "Robin: Well that’s interesting… = Man when are those drinks getting here… #34 = frack I thought this was a nice place. #35 = Didn’t I order our drinks like ten minutes ago? #36",
           "PLAYER_NAME: Man when are those drinks getting here… Have you been here before? Are they usually this slow? = next #37",
           "PLAYER_NAME: frack I thought this was a nice place. Where the hell are our drinks. Don’t you hate places with slow service? = next #37",    
           "PLAYER_NAME: Didn’t I order our drinks like ten minutes ago? What’s taking them so long? = next #37",
           "Robin: I’m sure they are working as fast as they can. = Don’t be so idiotic. If you want success in life you gotta take it. #38 = Don’t be so naive. These people will try to scam you if you give them the chance. #39 = You can’t be that dumb. I’ve seen our waiter pass by the bar 3 times by now and not get our drinks. #40",
           "PLAYER_NAME: Don’t be so idiotic. If you want success in life you gotta take it. = next #41",
           ...
           "Robin: Excuse me? You can't be serious. = What, you don’t believe me? #42 = Oh I’m serious alright. #43 = frack me I’m so thirsty. #44",
           ...
           "PLAYER_NAME: frack me I’m so thirsty. If only someone whose job it is to serve me drinks would get off their lazy bum! = next #45",
        ...
        dateB = new List<string>
        {
            ...
            "Robin: …  = next #44",
            "PLAYER_NAME: I had been paralized sitting in front of Robin. = next #45",
            "",
            "",
            "",
            "",
        ...
        dateC = new List<string>
        {
            ...
            "PLAYER_NAME: I never understood why we need realty agents. What’s so hard about selling a house. = next #42",
            "Robin: Oh believe me I do! [Robin regales you with an interesting story about a client she tried to sell a house for] = next #43",
            "Robin: It’s honestly not that hard but this one time when I was getting trained…. [Robin tells you a story about when she was learning to sell houses] = next #43",
            "Robin: Well I did have to do a lot of training so I don’t think anyone could just sell a house. = next #43",
            "Waiter: Here is your food. Enjoy = next #44",
            "The date continues and you have a wonderful time with Robbin. Afterwards you decided to go out again. = next #45",
            "",
            "",
            "",
            "",
