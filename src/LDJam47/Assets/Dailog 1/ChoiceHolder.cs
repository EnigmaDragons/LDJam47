...
public class ChoiceHolder : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        dateB = new List<string>
        {
            ...
            "Robin: Um… So… have you ever eaten here before? I’m not sure what to order. = Pinch yourself. #3 = Hit your hand with your spoon. #3 = Slap yourself. #3",
            "Robin: Hey don’t hurt yourself. What are you doing? = So I guess this isn’t a dream. #4 = This can’t be real. #4 = Am I high? #4",
            "Robin: Hey you don’t look so good. Hey Waiter, could we get some water? = next #5",
            "Waiter: Yeah of course. Is everything alright Player? = Water is fine. #6 = … #6 = Sure. Water.  #6",
            "Waiter: Here are your waters. = Take a drink of water #7 = … #7",
            "Robin: How are you feeling now? = I never thought I’d see you again.  #8 = You were just lying there. Motionless on the street. #8 = No matter how hard I try I can’t get that image out of my head. #8",
            "Robin: You know what. It seems like you are going through some stuff. Do you want to just call tonight off? I can order an Uber to take you home if you want? = If I’m not dreaming or high then what is all this? #9 = I don’t need to go home. I need to figure out what’s going on here.  #9 = … #9",
            "Robin: Ok well if you’re not even going to pretend like you are interested in our date then I’ll just head out. I hope everything works out for you. = Wait! I can’t let you leave. #10 = NO! You have to stay. #10 = Please… Don’t go. #10",
            "Robin: Why? There is clearly something in the matter and if you won’t talk to me about it then what am I supposed to do? = Please… Don’t go. #11 = Please… Don’t go. #11 = Please… Don’t go. #11",
            "Robin: Hey look, you seem nice enough, but I don’t know you and you have to admit you’re acting very strange.  = next #12",
            "Robin: I came out tonight because I wanted to have some fun. You have to understand that whatever is going on here…  = next #13",
            "Robin: Like I’m no one to judge… but if you’re not going to tell me what’s wrong I’m not going to sit here and babysit you. = If you leave you’ll die!  #14 = A bus is going to hit you for christ sake! #14 = Please… Don’t go. #14",
            "Robin: Alright then... I’m going to go.  = Don’t go. I love you #15 = Someone stop her! #15 = Please… Don’t go. #15",
            "Robin: …  = next #16",
            "Player: I had been almost paralized sitting in front of Robin. But when I heard that sound my instincts took over. I was already on the line with 911 before I got outside. But the scene was the same as the image burned into my mind.  = next #17",
            "Player: This is all my fault. = next #18",
        };
