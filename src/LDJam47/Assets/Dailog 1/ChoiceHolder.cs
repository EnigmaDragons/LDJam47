...
public class ChoiceHolder : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        {
            "Fade in to Player seated at the table with Robin. = next #2",
            "Robin: Well PLAYER_NAME you should probably plan ahead better next time. = next #3",
            "Player: ...what? = next #4",
            "Robin: Well = next #5",
            "Player: I just saw you get hit by a bus… = next #6",
            "Robin: Excuse me?  = next #7",
            "Player: You were just leaving and as you were crossing the street a bus just hit you. = next #8",
            "Robin: What are you talking about? I've been sitting here waiting for you. Can we just order?  = next #9",
            "Robin: Waiter! = next #10",
            "Robin calls over the waiter. = next #11",
            "Waiter: Good evening. I will be your waiter this evening. May I start you two off with something to drink? = Wait didn’t we already order? #12 = Didn’t you see Robin get hit by that bus? = #13 ",
            "Waiter: Well I’ve been here a few times but Robin asked me to wait until you arrived. = next #14",
            "Waiter: Hit by a bus? I think I would remember something like that. = next #14",
            "Robin: Just water is fine for me. = next #15",
            "Player: I must have hit my head pretty hard when I fainted. Uh… I guess just a water for me too. = next #16",
            "Waiter: Very good and do you know what entres you will be having this evening = #17",
            "Robin: I know what I want but I think PLAYER_NAME needs more time to decide. = #18",
            "Waiter: Very well then. = #19",
            "The waiter leaves and the player looks over the menu for a few minutes in silence.  =I’m not sure if I’m even hungry anymore. #20 =I was watching you leave, you started crossing the street, and then out of nowhere this bus comes and hits you.  #21 = How can you think about food right now? #22",
            "Robin: Well you need to get something I’m not gonna eat by myself. = next #22",
            "Robin: I think I would remember if something like that happened. You should check out the fish I hear it's great!  = next #22",
            "Robin: Well we’re at a restaurant why wouldn’t I be.  = next #22",
            "Player: So you don’t remember when I told you about my woodworking trip to Italy? = next #23",
            "Robin: Again this is the first time we’ve met. But I was in Italy last summer. They have some of the best cuisine in the world… = next #24",
            "Robin talks about their trip to Italy until the waiter returns with the drinks. = next #25",
            "Waiter: Here are your waters and have we decided on entres? = next #26",
            "Robin: I’ll have the fish. = Maybe you don’t remember because you hit your head after the bus hit you. #27  = But you look fine. I can’t even see a single scrape.  #27  = I was expecting to wake up in an ambulance or something.  #27",
